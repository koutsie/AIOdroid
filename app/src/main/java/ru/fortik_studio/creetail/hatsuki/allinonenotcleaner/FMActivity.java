...
import static ru.fortik_studio.creetail.hatsuki.allinonenotcleaner.Helper.fileExt;
...
import ru.fortik_studio.creetail.hatsuki.allinonenotcleaner.dialogs.ConfirmDeleteDialog;
import ru.fortik_studio.creetail.hatsuki.allinonenotcleaner.dialogs.RenameDialog;
import ru.fortik_studio.creetail.hatsuki.allinonenotcleaner.dialogs.UpdateItemDialog;

public class FMActivity extends AppCompatActivity implements
    ...
    mMovingLayout.findViewById(R.id.accept_move).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (mMovingPath != null) {
          ...
          if (!mCopy) {
            String toPath =
                getCurrentPath() + File.separator + mStorage.getFile(mMovingPath).getName();
            ...
            String toPath =
                getCurrentPath() + File.separator + "copy " + mStorage.getFile(mMovingPath)
                    .getName();
    ...
    if (file.isDirectory()) {
      ...
      try {
        ...
        String mimeType = MimeTypeMap.getSingleton()
            .getMimeTypeFromExtension(fileExt(file.getAbsolutePath()));
